# Enfoque 2 - Gramaticas probabilisticas lexicalizadas
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:

# El código crea una gramática libre de contexto probabilística lexicalizada (PCFG) que genera oraciones simples en español.
# Cada categoría gramatical (como NP, VP, Noun, Verb) tiene reglas con probabilidades, y la oración se construye recursivamente desde el símbolo inicial S.
# Su objetivo es simular la generación lingüística, produciendo frases como “el perro corre” o “rápido gato salta” según la estructura y las probabilidades definidas.
