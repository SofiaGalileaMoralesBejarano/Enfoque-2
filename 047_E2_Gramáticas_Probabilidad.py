# Enfoque 2 - Gramáticas Probabilidad Independencia del Contexto
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:

# El código implementa una gramática libre de contexto probabilística (PCFG) para generar oraciones aleatorias en español.
# Cada símbolo no terminal tiene reglas de producción con probabilidades, y las oraciones se construyen recursivamente según esas reglas.
# Su objetivo es simular la generación de lenguaje natural, creando frases simples basadas en una estructura gramatical probabilística.
