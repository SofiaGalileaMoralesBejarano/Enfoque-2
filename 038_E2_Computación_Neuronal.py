# Enfoque 2 - Computacion Neuronal
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:

# Implementa una red neuronal feedforward mínima con capas y neuronas propias (pesos y sesgo) usando ReLU.
# Solo hace propagación hacia adelante (sin entrenamiento) para las entradas del problema XOR y muestra la salida de la red.
# Demostrar la estructura y el flujo de datos en una red simple.
