# Enfoque 2 - Red Bayes Dinamica filtrado de Particulas
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:
# Implementa un filtro de Kalman 1D (posición–velocidad constante) que combina un modelo de movimiento (matrices A, Q, P) con mediciones ruidosas (H, R).
# En cada paso hace predicción y actualización para corregir el estado con la ganancia de Kalman KKK.
# Procesa una lista de mediciones y devuelve la posición estimada suavizada en cada iteración.
