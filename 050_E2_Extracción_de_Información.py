# Enfoque 2 - Extraccion de informacion
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:
# El código implementa un sistema simple de extracción de información que identifica nombres propios y fechas en un texto usando expresiones regulares.
# Detecta nombres con el formato “Nombre Apellido” y fechas.
# Su objetivo es automatizar la detección de entidades clave dentro de textos en lenguaje natural.
