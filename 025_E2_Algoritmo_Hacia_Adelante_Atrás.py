# Enfoque 2 - Algoritmo hacia delante, atras
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:
# Usa el algoritmo hacia adelante para obtener la probabilidad total de la secuencia de observaciones.
# Evaluar la verosimilitud de la secuencia y disponer de α y β para inferencia sobre estados ocultos.
