# Enfoque 2 - k-NN k-Medias y Clustering
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:

# Genera datos sintéticos, entrena un k-NN (k=3) para clasificar y muestra las predicciones en el set de prueba.
# Luego aplica k-means para agrupar todo el conjunto y visualiza los clusters con sus centroides.
# Contrastar un método supervisado (k-NN) vs. uno no supervisado (k-means) de forma visual.
