# Enfoque 2 - Recuperacion de datos
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:

# El código implementa un sistema básico de recuperación de documentos que busca textos que contengan todas las palabras de una consulta.
# Recorre una pequeña base de datos de oraciones y devuelve los IDs de los documentos coincidentes.
# Su objetivo es simular un buscador simple, similar a los motores de búsqueda por coincidencia de palabras clave.
