...
# Implementa EM para Mezclas Gaussianas (GMM) y agrupa datos 2D generados con make_blobs.
# Alterna Paso E (responsabilidades) y Paso M.
# Estimar centros, covarianzas y pesos de mezcla de los clusters.
