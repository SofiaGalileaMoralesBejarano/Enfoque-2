# Enfoque 2 - Aprendizaje Bayesiano
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:

# Divide los datos en entrenamiento y prueba, entrena el modelo y evalúa su rendimiento con la precisión obtenida.
# Su objetivo es demostrar cómo funciona Naïve Bayes en la clasificación de datos simples usando scikit-learn.
