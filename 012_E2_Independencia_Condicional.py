...
# Objetivo:
# El objetivo de este programa es simular tres eventos (A, B y C) y verificar si A es condicionalmente independiente de B dado C, 
# calculando y comparando sus probabilidades simples, conjuntas y condicionales.
