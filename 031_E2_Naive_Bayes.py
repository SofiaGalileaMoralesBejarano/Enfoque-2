...
# El código implementa manualmente el clasificador Naïve Bayes gaussiano, sin usar librerías externas de machine learning.
# Calcula las probabilidades de cada clase, la media y desviación estándar de las características, y evalúa la probabilidad gaussiana para predecir la clase más probable.
# Su objetivo es mostrar cómo funciona Naïve Bayes internamente, estimando la clase de una nueva muestra a partir de datos simples.
