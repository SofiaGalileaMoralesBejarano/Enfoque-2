# Enfoque - 2 Aprendizaje Profundo Dlearning
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:

# Implementa y entrena una red neuronal con ReLU en la capa oculta y sigmoide en la salida para aprender la función XOR.
# Usa propagación hacia adelante y backpropagation con actualización de pesos/sesgos y muestra la pérdida cada 100 épocas.
# Al final, calcula y muestra las predicciones del modelo entrenado sobre las cuatro entradas XOR.
