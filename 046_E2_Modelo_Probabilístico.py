# Enfoque 2 - Modelo Probabilistico del Lenguaje Corpus
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:

# El código implementa un modelo de lenguaje basado en n-gramas, que aprende patrones de co-ocurrencia de palabras a partir de un texto.
# Cuenta las frecuencias de secuencias de longitud n (aquí bigramas) y calcula la probabilidad de la siguiente palabra dada una anterior.
# Su objetivo es predecir la próxima palabra más probable según el contexto aprendido del corpus de entrenamiento.
