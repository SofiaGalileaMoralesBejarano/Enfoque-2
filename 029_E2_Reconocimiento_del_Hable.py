...
# Objetivo:
# El código simula un sistema básico de reconocimiento de voz que identifica palabras habladas a partir de una lista predefinida.
# Permite al usuario elegir o generar aleatoriamente una palabra, y luego muestra su interpretación semántica (como saludo o despedida).
