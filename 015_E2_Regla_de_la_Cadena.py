...
# El objetivo de este código es calcular la probabilidad conjunta de varios eventos (por ejemplo, P(A,B,C)P(A, B, C)P(A,B,C)) aplicando la regla de la cadena de probabilidad, 
# que descompone una probabilidad conjunta en el producto de probabilidades condicionales entre los eventos.
