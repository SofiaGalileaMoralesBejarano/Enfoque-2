# Enfoque 2 - Modelos ocultos de Markov
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo: 
# Implementa Viterbi para un HMM con dos estados y tres observaciones, hallando la secuencia de estados ocultos más probable dada una secuencia observada.
