...
# Objetivo:
# Implementa un HMM con tres estados ocultos.
# Usa el algoritmo hacia adelante para propagar probabilidades con matrices de transición y de emisión.
# Calcular la probabilidad total de la secuencia observada.
