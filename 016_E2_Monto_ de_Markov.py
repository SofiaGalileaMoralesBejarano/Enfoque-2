# Enfoque 2 - Manto de Markov
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:

# El objetivo de este código es simular un proceso de Markov, 
# generando una secuencia de estados a partir de un estado inicial y una matriz de transición que define 
# las probabilidades de pasar de un estado a otro durante varios pasos.


# Inicio del programa:

import numpy as np #Exportar Librerias necesarias


#Creamos clase MantodeMarkov
class MantoDeMarkov:
