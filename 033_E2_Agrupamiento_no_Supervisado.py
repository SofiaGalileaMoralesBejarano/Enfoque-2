...
# Aplica K-means para agrupar datos sintéticos en 4 clusters.
# Ajusta el modelo, asigna una etiqueta a cada punto y calcula los centros minimizando la varianza intra-cluster.
# Finalmente visualiza los grupos coloreados y los centroides.
