# Enfoque 2 - Probabilidad condicionada y normalizacion
# Autor: Sofia Galilea Morales Bejarano 6°E

# Objetivo:
# El objetivo de este programa es calcular y analizar probabilidades simples y condicionales entre dos eventos (A y B) simulados, 
# mostrando también sus combinaciones normalizadas para verificar que las probabilidades totales sumen 1.
